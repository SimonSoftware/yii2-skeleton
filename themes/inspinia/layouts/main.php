...
echo Nav::widget([
    ...
    'items' => [
        ['label' => 'Home', 'url' => '#page-top', 'linkOptions'=> ['class'=> 'page-scroll']],
        ['label' => 'Features', 'url' => '#features', 'linkOptions'=> ['class'=> 'page-scroll']],
        ['label' => 'Team', 'url' => '#team', 'linkOptions'=> ['class'=> 'page-scroll']],
        ['label' => 'Testimonials', 'url' => '#testimonials', 'linkOptions'=> ['class'=> 'page-scroll']],
        ['label' => 'Pricing', 'url' => '#pricing', 'linkOptions'=> ['class'=> 'page-scroll']],
